...
## **-> Roomie Edition**
In the source code `object_detection.cpp` we include a conditional to only detect one specific target with the ros parameter

`/object_deteccion/specific_target`

This must have the name of the object to be detected, as long as it is available in the detection possibilities of the selected neural network to be executed in the neural stick computer.

To enable this mode, you have to declare the rosparam

`/object_detecion/find_specific_target`

Defining it as **true** or **false** in the launch file as can be seen in the files

- myriad_demo_realsense.launch
- myriad_object_detection.launch
- 
<br>
<br>
